...
export default function PrivacyPolicy() {
  return (
    <Container maxW='3xl'>
      <Text color='gray'>Our Privacy Policy was last updated on 09/12/22.</Text>
      <Stack spacing={5}>
        <Heading>Introduction</Heading>
        <Text fontSize={{ md: 'xl', base: 'xl' }} lineHeight={'8'}>
        ...
        <Heading as='h5'>Definitions</Heading>
        ...
        <Text fontSize={{ md: 'xl', base: 'xl' }} lineHeight={'8'}>
          ...
          <ul>
            ...
            <li>
              ...
              "Our" in this Agreement) refers to Buylocate{' '}
            </li>
            ...
            <li>
              ...
              "Website" refers to Buylocate, accessible from
              https://buylocate.com
            </li>
            <li>
        ...
        <Heading as='h4'>Collecting and Using Your Personal Data</Heading>
        <Heading as='h5' color='gray'>
        ...
        <Text fontSize={{ md: 'xl', base: 'xl' }} lineHeight={'8'}>
          ...
          the Website. Tracking and Performance Cookies Type: Persistent Cookies
          ...
          the Website to see how our users react to them. For more information
          ...
          following purposes: To provide and maintain our Service, including to
          monitor the usage of our Service. To manage Your Account: to manage
          ...
          To manage Your requests: To attend and manage Your requests to Us. For
          business transfers: We may use Your information to evaluate or conduct
          ...
          use of our Service, for payment processing, to contact You. For
          ...
          for any other purpose with Your consent. Retention of Your Personal
          Data The Company will retain Your Personal Data only for as long as is
        ...
        <Heading as='h4'>Security of Your Personal Data</Heading>
        <Text fontSize={{ md: 'xl', base: 'xl' }} lineHeight={'8'}>
          The security of Your Personal Data is important to Us, but remember
          that no method of transmission over the Internet, or method of
          electronic storage is 100% secure. While We strive to use commercially
          acceptable means to protect Your Personal Data, We cannot guarantee
          its absolute security. Detailed Information on the Processing of Your
          Personal Data The Service Providers We use may have access to Your
          Personal Data. These third-party vendors collect, store, use, process
          and transfer information about Your activity on Our Service in
          accordance with their Privacy Policies. Payments We may provide paid
          products and/or services within the Service. In that case, we may use
          ...
          payment information. [LIST] Children's Privacy Our Service does not
          ...
          visiting this page on our website: https://buylocate.com/contact-us By
          sending us an email: buylocate@gmail.com
        </Text>
      </Stack>
    </Container>
  );
